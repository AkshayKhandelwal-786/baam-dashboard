...
import useSliderStore, { Slider } from 'src/features/slider/slider.service'
...
type PlanListColumn = Omit<GridColDef, 'field'> & { field: keyof Slider }
