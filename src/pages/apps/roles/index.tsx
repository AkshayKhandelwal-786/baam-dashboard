...
const RolesComponent = () => {
  ...
  const schemas = {
    ROLE: {
      ...
      super_admin: yup.boolean().label('Super Admin').meta({}).required()
    }
  }
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
                      <Box sx={{ display: 'flex', alignItems: 'flex-start', flexDirection: 'column' }}>
                        ...
                        <Typography
                          ...
                          onClick={e => {
                            e.preventDefault()
                            store.get.detail(item?._id, item)
                            handleAdd()
                          }}
                        >
                          Edit Role
                      ...
                      <Box>
                        ...
                        <IconButton sx={{ color: 'text.secondary' }}>
                          <Icon
                            ...
                            fontSize={20}
                            onClick={e => {
                              store.get.detail(null as any, { ...item, _id: null as any })
                              handleAdd()
                            }}
                          />
                        </IconButton>
