    ...
    <MenuHeaderWrapper className='nav-header' sx={{ pl: menuHeaderPaddingLeft() }}>
      {userNavMenuBranding ? (
        ...
        <LinkStyled href='/' sx={{ ml: 3 }}>
          ...
          <img src={'/images/logo/vertical-logo.png'} alt={'logo'} height={30} style={{ margin: 20 }} />

          {/* <img src={'/images/logo/smallLogo.png'} alt={''} width={30} height={30} />
