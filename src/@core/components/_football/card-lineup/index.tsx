...
const CardLineup = (props: CardSnippetProps) => {
  ...
  const handlePlaying11Select = (playerId: number) => {
          ...
          <ListSubheader sx={{ padding: 'unset' }}>
            <ListItemButton>
              ...
              <ListItemSecondaryAction tabIndex={10} style={{ display: 'flex', justifyContent: 'space-between' }}>
                <Typography variant='body2'>Playing11</Typography>
                  ...
                  >
                    ...
                    <ListItemSecondaryAction tabIndex={10}>
                      ...
                      <IconButton
                        ...
                        color={playing11s.includes(player.id) ? 'primary' : 'default'}
                        sx={{ opacity: playing11s.includes(player.id) ? 1 : 0.2 }}
                      >
                      ...
                      <IconButton
                        ...
                        sx={{ opacity: substitutes.includes(player.id) ? 1 : playing11s.includes(player.id) ? 0.2 : 0 }}
                      >
