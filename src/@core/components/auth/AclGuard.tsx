...
// ** Config Import
import { _buildAbilityFor, buildAbilityFor } from 'src/configs/acl'
...
const AclGuard = (props: AclGuardProps) => {
  ...
  if (auth.user && !ability) {
    ...
    if (router.route === '/') {
      console.log("Spinner - User is logged in, build ability for the user based on his role")
      return <Spinner />
    }
  }
  ...
  if (ability && auth.user) {
    if (router.route === '/') {
      console.log("Spinner - Check the access of current user and render pages")
      return <Spinner />
    }
